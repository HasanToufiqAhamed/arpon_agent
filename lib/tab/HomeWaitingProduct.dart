...
import 'package:arpon_agent/list/ProductListNotClick.dart';
...
class HomeWaitingProduct extends StatefulWidget {
  HomeWaitingProduct({Key? key}) : super(key: key);

  _HomeWaitingProductState createState() => _HomeWaitingProductState();
}

class _HomeWaitingProductState extends State<HomeWaitingProduct> {
              ...
              children: [
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ProductListNotClick(product, context);
                  },
                ),
                Visibility(
                    ...
                    child: TextButton(
                      onPressed: () {
                        /*Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                SellerAllProduct(widget.sellerUid),
                          ),
                        );*/
                      },
                      style: ButtonStyle(
