...
class DoneNotPaymentOrder extends StatefulWidget {
  DoneNotPaymentOrder({Key? key}) : super(key: key);

  @override
  _oneNotPaymentState createState() => _oneNotPaymentState();
}

class _oneNotPaymentState extends State<DoneNotPaymentOrder> {
  ...
  Future<Null> getData() async {
    ...
    if (_lastVisible == null) {
      data = await firestore
          ...
          .where('sellerPayment', isEqualTo: false)
          .limit(20)
          .get();
    } else {
      data = await firestore
