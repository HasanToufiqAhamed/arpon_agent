...
class SendNotConformOrder extends StatefulWidget {
  SendNotConformOrder({Key? key}) : super(key: key);

  @override
  _ActiveOrderState createState() => _ActiveOrderState();
}

class _ActiveOrderState extends State<SendNotConformOrder> {
